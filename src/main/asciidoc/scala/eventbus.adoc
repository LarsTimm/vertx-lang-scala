...
When the receiver receives the message they can reply to it by calling `link:scaladocs/io/vertx/scala/core/eventbus/Message.html#reply(java.lang.Object)[reply]`.
